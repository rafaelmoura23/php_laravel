                ...
                <tr>
                    ...
                    @foreach ($calendario['dias'] as $dia)
                        <td>
                            ...
                            <div id="horarios-{{ $dia->format('Y-m-d') }}"
                                class="horarios-dia" style="display: none; margin-top: 5px;">
...
@endforeach
    ...
    <script>
        function toggleDias(mesAno) {
            console.log('Toggling days for:', mesAno); // Log para depuração
        ...
        function toggleHorarios(dia) {
            console.log('Toggling horarios for:', dia); // Log para depuração
